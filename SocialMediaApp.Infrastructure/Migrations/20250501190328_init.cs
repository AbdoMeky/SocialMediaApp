        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwosomeChatID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentOnlineUsers", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReseaverId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FriendShipRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FriendShipRequests_User_ReseaverId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TwosomeChatMessage_ChatId = table.Column<int>(type: "int", nullable: true),
                    TwosomeChatMessage_MemberId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_ChatMember_TwosomeChatMessage_MemberId",
                        column: x => x.TwosomeChatMessage_MemberId,
                        principalTable: "ChatMember",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Messages_Chat_TwosomeChatMessage_ChatId",
                        column: x => x.TwosomeChatMessage_ChatId,
                        principalTable: "Chat",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageStatus_ChatMember_MemberId",
                        column: x => x.MemberId,
                        principalTable: "ChatMember",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatMember_GroupChatId",
                table: "ChatMember",
                column: "GroupChatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendShipRequests_ReseaverId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_TwosomeChatMessage_ChatId",
                table: "Messages",
                column: "TwosomeChatMessage_ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_Messages_TwosomeChatMessage_MemberId",
                table: "Messages",
                column: "TwosomeChatMessage_MemberId");

            migrationBuilder.CreateIndex(
                name: "IX_MessageStatus_MemberId",
                table: "MessageStatus",
                column: "MemberId");
