...
namespace SocialMediaApp.API.Controllers
{
    ...
    [ApiController]
    public class TwoSomeChatMessageController : ControllerBase
    {
        private readonly IMessageRepository _messageRepository;

        public TwoSomeChatMessageController(IMessageRepositoryFactory factory)
        {
            _messageRepository = factory.CreateRepository("TWO");
        }
        [HttpPost]
        [Authorize]
